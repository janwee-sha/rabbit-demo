...
public class Sender {
    public static void main(String[] args) throws Exception {
        ...
        try (Channel channel = ConnectionFactory.createChannel()) {
            ...
            channel.queueBind(Property.QUEUE_HELLO, Property.DIRECT_EXCHANGE_NAME, Property.ROUTABLE_KEY_1);
//            channel.queueBind(Property.QUEUE_HAY, Property.DIRECT_EXCHANGE_NAME, Property.ROUTABLE_KEY_1);
            ...
            //purge messages
            channel.queuePurge(Property.QUEUE_HELLO);
